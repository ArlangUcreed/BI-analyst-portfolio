...
### 🐍 Jupyter Notebook
- `python/` — projects with data analysis

### 🗄️ SQL (DBeaver)
- `sql/` — queries, views, cohort analysis

### 📊 Dashboards
- `dashboards/screenshots/` — screenshots of DataLens and Superset dashboards
...
- **GitHub:** [github.com/ваш_username](https://github.com/my_username)
